                ...
                <div class="col-12 col-xl-4">
                    <div class="panel h-100 text-center profile-card">
                        ...
                        <div class="profile-cover">
                            <img src="https://via.placeholder.com/600x200" alt="Cover" class="img-fluid w-100">
                        </div>

                        @if (!empty($student->photo))
                            <img class="avatar-img avatar-xl profile-photo" src="{{ asset($student->photo) }}"
                                alt="{{ $student->name }}">
                        @else
                            <img class="avatar-img avatar-xl profile-photo" src="https://via.placeholder.com/120"
                                alt="Student">
                        @endif
                    ...
                    <div class="panel">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" rows="4" readonly>{{ $student->address }}</textarea>
                            </div>
